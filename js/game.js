class MainScene extends Phaser.Scene {
    ...
    startGame() {
        ...
        this.player.setScale(0.1); // Starting with a smaller scale for the new sprite
        this.player.setDepth(1);
        
        // Initial rotation to point upward (if needed)
        this.player.rotation = -Math.PI / 2; // Rotate 90 degrees counterclockwise
    ...
    updatePlayerRotation(pointer) {
        ...
        // Add 90 degrees to the rotation to compensate for the initial rotation
